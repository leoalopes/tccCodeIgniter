...
<body>
        ...
        <div class="row">
              ...
              <div class="row">
                ...
                <div class="col s6 m6 input-field">
                  ...
                  <input name="hora" id="hora" type="time" class="timepicker" value="<?php echo substr($reuniao['data'], 11, 5); ?>">
                </div>
              </div><br>
              <div class="row">
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#data").pickadate('picker').set('select', '<?php echo substr($reuniao['data'], 0, 10); ?>', { format: 'yyyy-mm-dd' });
      $("#motivo").val('<?php echo $reuniao['motivo']; ?>');
      setTimeout(function() {
    ...
    default: '<?php echo substr($reuniao['data'], 11, 5); ?>', // Set default time
